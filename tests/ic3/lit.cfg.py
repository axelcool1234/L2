...
# Set timeout for tests to prevent infinite runs (IC3 can be slow)
config.maxIndividualTestTime = 60  # 60 seconds timeout for verification tests  # pyrefly: ignore
